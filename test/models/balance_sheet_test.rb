...
class BalanceSheetTest < ActiveSupport::TestCase
  ...
  test "calculates asset group totals" do
    ...
    assert_equal 3000, asset_groups.find { |ag| ag.name == "Investment" }.total
    assert_equal 5000, asset_groups.find { |ag| ag.name == "Other Asset" }.total
  end
  ...
  test "calculates liability group totals" do
    ...
    assert_equal 1000 + 2000, liability_groups.find { |ag| ag.name == "Credit Card" }.total
    assert_equal 3000 + 5000, liability_groups.find { |ag| ag.name == "Other Liability" }.total
  end
